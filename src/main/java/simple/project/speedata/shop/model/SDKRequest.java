...
@SequenceGenerator(name = "SEQ_SPEEDATA_SDK_REQUEST", sequenceName = "SEQ_SPEEDATA_SDK_REQUEST")
@GenericGenerator(name = "idStrategy", strategy = "native", parameters = {
		@Parameter(name = "sequence", value = "SEQ_SPEEDATA_SDK_REQUEST") })
public class SDKRequest extends BaseModel implements Serializable {
