...
@Entity
@Table(name = "SPEEDATA_SHOP_COMPANY")
...
@SequenceGenerator(name = "SEQ_SPEEDATA_SHOP_COMPANY", sequenceName = "SEQ_SPEEDATA_SHOP_COMPANY")
@GenericGenerator(name = "idStrategy", strategy = "native", parameters = {
		@Parameter(name = "sequence", value = "SEQ_SPEEDATA_SHOP_COMPANY") })
public class Company extends BaseValiditySupportModel implements Serializable {
